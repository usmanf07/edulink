  ...
  render(){
    return (
      <div className='MainNavDiv'>
          ...
          <div className="IconLogoDiv"><img className="logoSmallWhite1Icon" alt="" src="/logosmallwhite-1@2x.png"></img>  </div>
        ...
        <nav className="nav" id="navbar">
          ...
          <img className="logoSmallWhite1Icon" alt="" src="/logosmallwhite-1@2x.png"></img>
